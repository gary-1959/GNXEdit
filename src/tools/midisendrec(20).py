...
#ms.append("F0 00 00 10 00 56 12 00 01 01 00 54 F7")

ms.append("F0 00 00 10 00 56 20 00 01 00 04 1F 7C F7")     # response 21 gets factory patch name and params (amp?, cab?)
#ms.append("F0 00 00 10 00 56 20 00 01 01 04 1F 7D F7")     # response 21 gets user patch name and params (amp?, cab?)
#ms.append("F0 00 00 10 00 56 20 00 01 02 00 1F 7A F7")     # response 21 gets buffer patch name and params (amp?, cab?)
