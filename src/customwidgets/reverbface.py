# reverbface.py
#
# CPGen Reverb widget for Digitech GNX1
#
...
class ReverbFace(QWidget):

    POTS = {
        "pot_1": {"minval": 0, "maxval": 15, "minunit": 0, "maxunit": 15, "prefix": "", "suffix":"", "dialmin": 1, "dialmax": 10, "dialstep": 1, "img": "direct",
        ...
        "pot_5": {"minval": 0, "maxval": 99, "minunit": 0, "maxunit": 99, "prefix": "", "suffix":"", "dialmin": 1, "dialmax": 10, "dialstep": 1, "img": "direct",
                    "x": 678, "y": 36, "w": 60, "h": 60, "start": 45, "end": 315, "rotate": 180, "ds": 2, "color": Qt.black,  "ticks": True,  "marks": range(1,11,1),
                    "unitscale": None, "tooltipformat": "0.0f" },
    }

    reverbChanged = Signal(int, int)
    reverbPotChanged = Signal(int, dict)    # parameter, pot
    ...
    def __init__(self, parent = None):
        ...
        self.button_on = {"x": 103, "y": 53, "w": 34, "h": 34, "off": "reverb_off.png", "on": "reverb_on.png"}

        self.button_studio = None
        self.button_room = None
        self.button_club = None
        self.button_plate = None
        self.button_hall = None
        self.button_theatre = None
        self.button_church = None
        self.button_garage = None
        self.button_arena = None
        self.button_spring = None

        self.buttons = [
            "button_studio", "button_room", "button_club", "button_plate", "button_hall", 
            "button_theatre", "button_church", "button_garage", "button_arena", "button_spring"
            ]
        x = 292
    ...
    def sendExpPots(self):
        self.reverbPotChanged.emit(0x02, self.POTS["pot_1"])
        self.reverbPotChanged.emit(0x03, self.POTS["pot_2"])
        self.reverbPotChanged.emit(0x04, self.POTS["pot_3"])
        self.reverbPotChanged.emit(0x05, self.POTS["pot_4"])
        self.reverbPotChanged.emit(0x06, self.POTS["pot_5"])
    ...
    def setReverbType(self, value):
        self._type = int(value)
        self.reverbChanged.emit(0, value)
    ...
    def setOn(self, value):
        self._on = value
        self.reverbChanged.emit(1, value)

    def setParam1(self, value):
        self._param1 = value
        self.reverbChanged.emit(2, value)

    def setParam2(self, value):
        self._param2 = value
        self.reverbChanged.emit(3, value)

    def setParam3(self, value):
        self._param3 = value
        self.reverbChanged.emit(4, value)

    def setParam4(self, value):
        self._param4 = value
        self.reverbChanged.emit(5, value)

    def setParam5(self, value):
        self._param5 = value
        self.reverbChanged.emit(6, value)

    def setReverb(self, type = None, on = None, param1 = None, param2 = None, param3 = None, param4 = None, param5 = None):
    ...
    def paintEvent(self, event):
        ...
        png = "reverb-0.png"
        img = cache_image(f"reverb:{png}", os.path.join(os.path.dirname(__file__), "images/reverbface/", f"{png}"))
        ...
        match self._on:
            case 0: # off
                d = cache_image(f"reverb:{self.button_on["off"]}", os.path.join(os.path.dirname(__file__), "images/reverbface/", f"{self.button_on["off"]}"))
            case 1: # on
                d = cache_image(f"reverb:{self.button_on["on"]}", os.path.join(os.path.dirname(__file__), "images/reverbface/", f"{self.button_on["on"]}"))
        ...
        for bname in self.buttons:
            ...
            if n == self._type:
                bimg = b["on"]
                img = cache_image(f"reverb:{bimg}", os.path.join(os.path.dirname(__file__), "images/reverbface/", bimg))
            else:
                bimg = b["off"]
                img = cache_image(f"reverb:{bimg}", os.path.join(os.path.dirname(__file__), "images/reverbface/", bimg))
    ...
    reverbType = Property(int, reverbType, setReverbType)